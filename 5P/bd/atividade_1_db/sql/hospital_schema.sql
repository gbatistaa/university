...
CREATE TABLE hospital.usuario(
  ...
  CONSTRAINT fk_perfil FOREIGN KEY (idPerfil) REFERENCES hospital.perfil(idPerfil) ON DELETE
...
CREATE TABLE hospital.mora(
  ...
  CONSTRAINT fk_endereco_mora FOREIGN KEY (idEndereco) REFERENCES hospital.endereco(idEndereco),
  CONSTRAINT fk_cpf_mora FOREIGN KEY (cpf) REFERENCES hospital.usuario(cpf) ON DELETE
  SET NULL ON UPDATE CASCADE
);
CREATE TABLE hospital.fone(
  ...
  CONSTRAINT fk_cpf_fone FOREIGN KEY (cpf) REFERENCES hospital.usuario(cpf) ON DELETE
  SET NULL ON UPDATE CASCADE
);
CREATE TABLE hospital.atendente(
  cpf hospital.tipo_cpf,
  CONSTRAINT pk_atendente_cpf PRIMARY KEY (cpf),
  CONSTRAINT fk_cpf_atendente FOREIGN KEY (cpf) REFERENCES hospital.usuario(cpf) ON DELETE
  SET NULL ON UPDATE CASCADE
);
CREATE TABLE hospital.acompanhante(
  cpf hospital.tipo_cpf,
  CONSTRAINT pk_acompanhante_cpf PRIMARY KEY (cpf),
  CONSTRAINT fk_cpf_acompanhante FOREIGN KEY (cpf) REFERENCES hospital.usuario(cpf) ON DELETE
  SET NULL ON UPDATE CASCADE
);
CREATE TABLE hospital.paciente(
  ...
  CONSTRAINT fk_cpf_paciente FOREIGN KEY (cpf) REFERENCES hospital.usuario(cpf),
  CONSTRAINT fk_cpf_acomp FOREIGN KEY (cpfAcomp) REFERENCES hospital.acompanhante(cpf) ON DELETE
  SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE hospital.acesso_hist_atend_perf (
  ...
  CONSTRAINT fk_idhistorico_acesso FOREIGN KEY (idHistorico) REFERENCES hospital.historico(idHistorico),
  CONSTRAINT fk_cpf_acesso_atedente FOREIGN KEY (cpfAtendente) REFERENCES hospital.atendente(cpf),
  CONSTRAINT fk_idperfil_acesso FOREIGN KEY (idPerfil) REFERENCES hospital.perfil(idPerfil) ON DELETE
  SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE hospital.medico (
  ...
  CONSTRAINT fk_medico_cpf FOREIGN KEY (cpf) REFERENCES hospital.usuario(cpf) ON DELETE
  SET NULL ON UPDATE CASCADE
);
CREATE TABLE hospital.medico_docente (
  ...
  CONSTRAINT fk_medico_docente_cpf FOREIGN KEY (idRegistro) REFERENCES hospital.medico(idRegistro) ON DELETE
  SET NULL ON UPDATE CASCADE
);
CREATE TABLE hospital.medico_residente (
  ...
  CONSTRAINT fk_medico_residente FOREIGN KEY (idRegistro) REFERENCES hospital.medico(idRegistro) ON DELETE
  SET NULL ON UPDATE CASCADE
);
CREATE TABLE hospital.consulta (
  ...
  CONSTRAINT fk_consulta_registro FOREIGN KEY (idRegistroMedico) REFERENCES hospital.medico(idRegistro),
  CONSTRAINT fk_consulta_atendente FOREIGN KEY (cpfAtendente) REFERENCES hospital.atendente(cpf),
  CONSTRAINT fk_consulta_historico FOREIGN KEY (idHistorico) REFERENCES hospital.historico(idHistorico),
  CONSTRAINT fk_consulta_paciente FOREIGN KEY (numProntuario) REFERENCES hospital.paciente(numProntuario) ON DELETE
  SET NULL ON UPDATE CASCADE
);
CREATE TABLE hospital.exame (
  ...
  CONSTRAINT fk_exame_registro_medico_doc FOREIGN KEY (idRegistroMedicoDocente) REFERENCES hospital.medico_docente(idRegistro),
  CONSTRAINT fk_exame_paciente FOREIGN KEY (numProntuario) REFERENCES hospital.paciente(numProntuario) ON DELETE
  SET NULL ON UPDATE CASCADE
);
CREATE TABLE hospital.solicitacao_exame (
  ...
  CONSTRAINT fk_solic_exame FOREIGN KEY (idExame) REFERENCES hospital.exame(idExame),
  CONSTRAINT fk_solic_exame_medico FOREIGN KEY (idRegistroSolicitante) REFERENCES hospital.medico(idRegistro) ON DELETE
  SET NULL ON UPDATE CASCADE
);
CREATE TABLE hospital.laudo (
  ...
  CONSTRAINT fk_laudo_med_revisor FOREIGN KEY (idMedicoRevisorResidente) REFERENCES hospital.medico_residente(idRegistro),
  CONSTRAINT fk_laudo_med_emissor FOREIGN KEY (idMedicoEmissorDocente) REFERENCES hospital.medico_docente(idRegistro),
  CONSTRAINT fk_laudo_exame FOREIGN KEY (idExame) REFERENCES hospital.exame(idExame) ON DELETE
  SET NULL ON UPDATE CASCADE
);
CREATE TABLE hospital.prescricao (
  ...
  numProntuario VARCHAR(15) NOT NULL,
  PRIMARY KEY (
    idConsultaPrescricao,
    idMedicamento,
    numProntuario
  ),
  CONSTRAINT fk_presc_med2 FOREIGN KEY (idMedicamento) REFERENCES hospital.medicamento(idMedicamento) ON DELETE
  SET NULL ON UPDATE CASCADE
);
...
VALUES (
    'neymar_si',
    'IAfXsniaoRfqeFlHsejpKsSvJtay7W',
    'S'
  );
INSERT INTO hospital.perfil (login, senhaCriptograda, ativo)
VALUES (
    'juli_cesar',
    't0MlSabsALBNPvIDToyCkcF0HeyaK7',
    'S'
  );
INSERT INTO hospital.perfil (login, senhaCriptograda, ativo)
VALUES (
    'mta-santos',
    'RqcnaISXs7OPPEVRV6II3SaBd5pRmj',
    'S'
  );
INSERT INTO hospital.perfil (login, senhaCriptograda, ativo)
VALUES (
    'maria_stos',
    'aVkB8gVsnHOBtaUQtB62iz2FHzVain',
    'S'
  );
INSERT INTO hospital.perfil (login, senhaCriptograda, ativo)
VALUES (
    'jord_cosa',
    'oieAUA1zjao0VaOcmnAgSDnvWhJoAe',
    'S'
  );
INSERT INTO hospital.perfil (login, senhaCriptograda, ativo)
VALUES (
    'maria_st',
    'DNaSgaUjfrhooFQnJ7gjPoOk0Qnml0',
    'S'
  );
INSERT INTO hospital.perfil (login, senhaCriptograda, ativo)
...
VALUES (
    'thio_silva',
    'oiaQCCUUGuaOIaT6Yzndn8DxJjD8b1',
    'S'
  );
INSERT INTO hospital.perfil (login, senhaCriptograda, ativo)
VALUES (
    'david-luiz',
    'BIHjb4DtWtiaShYAdzE4aQwOBwZ8LE',
    'S'
  );
INSERT INTO hospital.perfil (login, senhaCriptograda, ativo)
VALUES (
    'marc_ruim',
    'AsoGngj2TwIjcVVmNoavkoo8dooAnK',
    'S'
  );
INSERT INTO hospital.perfil (login, senhaCriptograda, ativo)
VALUES (
    'hers_silva',
    'jkaWxnHkVjSgjQWxWVZOnL2GhcoFGz',
    'S'
  );
INSERT INTO hospital.perfil (login, senhaCriptograda, ativo)
...
VALUES (
    'marijose',
    'SrLfHKn1VObQ9opM0oI8fod2oViler',
    'S'
  );
INSERT INTO hospital.perfil (login, senhaCriptograda, ativo)
...
VALUES ('06-23-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('05-12-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('04-05-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('02-20-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('01-23-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('06-09-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('06-15-2018', 'removeu');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('02-23-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('07-09-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('06-18-2018', 'modificou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('02-14-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('01-06-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('01-22-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('02-08-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('02-17-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('05-18-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('06-19-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('06-18-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('04-18-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('04-18-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('02-18-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('03-19-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('03-01-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('02-03-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('05-06-2018', 'cadastrou');
INSERT INTO hospital.historico (dataCad, acao)
VALUES ('05-06-2018', 'modificou');
...
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES (
    'Glucobay',
    '50mg',
    'comprimido',
...
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES ('Proflam', '250mg', 'capsula', '3 vezes ao dia');
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES (
    'Advantan',
    '350mg',
...
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES ('Amoxilina', '20mg', 'capsula', '1 vez ao dia');
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES (
    'Depo-Provera',
    '50mg',
...
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES ('Vita E', '40mg', 'capsula', '3 vezes ao dia');
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES (
    'Aspirina',
    '50mg',
...
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES ('Somalgin', '100mg', 'capsula', '6 vezes ao dia');
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES (
    'Somalgin Cardio',
    '260mg',
...
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES ('Somalgin', '400mg', 'capsula', '2 vezes ao dia');
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES ('AAS', '30mg', 'comprimido', '4 vezes ao dia');
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES (
    'Sonrisal limao',
    '100mg',
...
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES ('Plastenan', '50mg', 'capsula', '1 vez ao dia');
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES ('Bonalen', '60mg', 'comprimido', '1 vez ao dia');
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES ('Ipsilon', '50mg', 'comprimido', '1 vez ao dia');
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES (
    'Eaca balsamico xpe',
    '250mg',
...
INSERT INTO hospital.medicamento (nome, apresentacao, unidade, posologia)
VALUES ('Omeprazol', '450mg', 'capsula', '1 vez ao dia');
...
INSERT INTO hospital.prescricao (
    idConsultaPrescricao,
    idMedicamento,
    numProntuario
  )
