 ...
 *
 * Propósito:
 *    Implementar um sistema de reservas de assentos para um cinema com
 * múltiplos caixas, demonstrando uma condição de corrida (race condition) e a
 ...
 *
 * Observação:
 *    Este código intencionalmente contém uma race condition para fins
 * didáticos. A solução com mutex deve ser implementada pelos alunos.
 */
#include <pthread.h>
#include <stdio.h>
#include <unistd.h>
